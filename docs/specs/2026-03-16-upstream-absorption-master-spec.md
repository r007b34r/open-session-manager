...
- 已落地：clean-room 会话发现与解析
- 未落地：active cockpit、跨会话搜索、schema drift 治理、resume 控制
...
- 已落地：本轮开始接入，目标是先做本地 usage/cost 面板
...
- 待吸收：lexical / semantic / hybrid search
